...
@Component({
  ...
  templateUrl: './dist-goods-table.component.html',
  styleUrls: ['./dist-goods-table.component.scss']
})
export class DistGoodsTableComponent implements OnInit, OnChanges {
  @Input() source: any;
  @Output() dataChanged = new EventEmitter();
  count = null;
  selectedRow = null;
  displayedColumns: string[] = ['product', 'pack', 'rop'];
  goods;
  form: FormGroup;
